...
//import static com.framework.listeners.MobileEvent.*;

import static com.framework.goodhealthgateway.listeners.MobileEvent.*;
...
public class sendEmail_outlook extends ReportManager{
    ...
    public static void sendReportByOutlook() throws IOException {
            ...
            //Credentials:
         String username = "teamautomation@quality-matrix.com";
         String password = "fRAMEWORK@123";
    ...
    // Setting date for subject
        ...
        //Setting From and to recipients
            ...
            message.setRecipients(Message.RecipientType.TO,
                    InternetAddress.parse("sanjoosha_makahani@quality-matrix.com"));
            message.setRecipients(Message.RecipientType.CC, InternetAddress.parse("chaitanya@quality-matrix.com"));
        //Setting subject
            System.out.println(strDate);
            message.setSubject("GHG Mobile Automation Test Report - " + strDate + "");
            ...
            String filename = System.getProperty("user.dir") + "/Reports/MobileReports/" + dateStamp
                    + "/" + "GHG-" + timeStamp + ".html";
